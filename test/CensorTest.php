...
class CensorTest extends TestCase
{
    ...
    public function sentenceProvider(): array
    {
        return [
            ...
            ["Une phrase accentuée", "Une phrase accentuée", "", "Censoring using a blank word must let sentences unchanged"],
            ["S*******", "Sentence", "Sentence", "Censoring Sentence in Sentence must return S*******"],
            ["V******** is back", "Voldemort is back", "voldemort", "Censoring voldemort in 'Voldemort is back' must return V******** is back"],
            ...
            [
                ...
                "nez", "Censoring nez in 'En variant le ton, – par exemple, tenez : Agressif : « Moi, monsieur, si j’avais un tel nez, il faudrait sur-le-champ que je me l’amputasse ! »' must return 'En variant le ton, – par exemple, ten** : Agressif : « Moi, monsieur, si j’avais un tel n**, il faudrait sur-le-champ que je me l’amputasse ! »'"
            ],
            ["W*** and w***", "Word and word", "Word", "Censoring Word in 'Word and word' must return 'W*** and w***'"],
            ["W*** and w***", "Word and word", "word", "Censoring word in 'Word and word' must return 'W*** and w***'"],
